...
```sh
bash ~/.claude/skills/reference-explorers/plugin-browser/scripts/clone-references.sh
```
...
```sh
bash ~/.claude/skills/reference-explorers/plugin-browser/scripts/clone-references/clone-anthropics-claude-plugins-official.sh
```

### 2. Index for semantic search

```sh
bash ~/.claude/skills/reference-explorers/plugin-browser/scripts/index-references.sh
```
